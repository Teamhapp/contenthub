...
export default function WishlistPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Page Header */}
      <div>
        <h1 className="section-title text-2xl">My Wishlist</h1>
        <p className="text-surface-500 mt-1">Content you&apos;ve saved for later</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="card text-center py-16">
          ...
          <p className="text-surface-500 text-lg mb-1 font-medium">Your wishlist is empty</p>
